...
@Component({
  selector: 'app-verification-request-modal-content',
  template: `
    <div class="modal-header bg-warning text-white">
      <h4 class="modal-title">Pending<br/><small>YouTube Evidence Request Submitted</small></h4>
    ...
    <div class="modal-body">
      <div class="card mb-4">
        <div class="card-block row m-1">
          <h5 class="card-title col-md-12 p-1">Verification Request</h5>
...
export class VerificationRequestComponent {
  @Input() data: VerificationRequest | undefined;
